...
const Login = ({ authStatus, setAuthStatus }) => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch("https://rendersgr1server-production.up.railway.app/auth/login", {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                const authResponse = await fetch("https://rendersgr1server-production.up.railway.app/auth/status", {
