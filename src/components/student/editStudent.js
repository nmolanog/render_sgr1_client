...
export default function EditStudent(props) {
    ...
    const handleSubmitForm = async (e) => {
        ...
        try {
            ...
            const responseAllIds = await fetch("https://rendersgr1server-production.up.railway.app/student/allids",
                {
                    method: "GET",
            ...
            const responseCopy = await fetch(`https://rendersgr1server-production.up.railway.app/student/copy/${student.id_stu}`,
                {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    credentials: "include"
            ...
            const response = await fetch(`https://rendersgr1server-production.up.railway.app/student/edit/${student.id_stu}`,
                {
                    method: "PUT",
                    headers: { "Content-Type": "application/json" },
