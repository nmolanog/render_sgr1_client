...
export default function Appointments() {
    ...
    useEffect(() => {
        const getAppointments = async () => {
            try {
                const responseAppointments = await fetch(`https://rendersgr1server-production.up.railway.app/appointment/search4commit_id/${commit_id}`,
                    {
                        method: "GET",
    ...
    useEffect(() => {
        ...
        const getAppointmentsDates = async () => {
            if (appointment.length > 0) {
                try {
                    const responseAppoDates = await fetch(`https://rendersgr1server-production.up.railway.app/appointment/searchallappo/${appointment[0].enroll_id}`,
                        {
                            method: "GET",
                            headers: { "Content-Type": "application/json" },
                            credentials: "include"
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://rendersgr1server-production.up.railway.app/appointment/insert",
                {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
            ...
            if (formData.end_commit === "yes") {
                const response2 = await fetch(`https://rendersgr1server-production.up.railway.app/commitment/end/${commit_id}`,
                    {
                        method: "PUT",
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify(formData),
            ...
            if (formData.end_commit === "yes" && appointment[0].duration === appointment[0].commit_num) {
                const response3 = await fetch(`https://rendersgr1server-production.up.railway.app/enrollment/end/${appointment[0].enroll_id}`,
                    {
                        method: "PUT",
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify(formData),
    ...
    const handleSubmitUnfullfiled = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`https://rendersgr1server-production.up.railway.app/appointment/fullfile/${unfulfilledApoIds}`,
                {
                    method: "PUT",
                    headers: { "Content-Type": "application/json" },
            ...
            if (unfulfilledForm.end_commit === "yes") {
                const response2 = await fetch(`https://rendersgr1server-production.up.railway.app/commitment/edit/${commit_id}`,
                    {
                        method: "PUT",
                        headers: { "Content-Type": "application/json" },
            ...
            if (unfulfilledForm.end_commit === "yes" && appointment[0].duration === appointment[0].commit_num) {
                const response3 = await fetch(`https://rendersgr1server-production.up.railway.app/enrollment/edit/${appointment[0].enroll_id}`,
                    {
                        method: "PUT",
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify(tempFormData),
