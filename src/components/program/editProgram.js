...
export default function EditProgram(props) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const responseNumEnroll = await fetch(`https://rendersgr1server-production.up.railway.app/program/enrollments/${program.id}`,
                {
                    method: "GET",
    ...
    const handleSubmitForm = async (e) => {
        ...
        try {
            ...
            const responseAllNames = await fetch("https://rendersgr1server-production.up.railway.app/program/allnames",
                {
                    method: "GET",
                    headers: { "Content-Type": "application/json" },
                    credentials: "include"
            ...
            const responseCopy = await fetch(`https://rendersgr1server-production.up.railway.app/program/copy/${program.id}`,
                {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    credentials: "include"
            ...
            const response = await fetch(`https://rendersgr1server-production.up.railway.app/program/edit/${program.id}`,
                {
                    method: "PUT",
                    headers: { "Content-Type": "application/json" },
                    credentials: "include",
