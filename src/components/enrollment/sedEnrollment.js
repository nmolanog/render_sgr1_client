...
export default function SedEnrollment() {
    ...
    const getAllEnrollments = async () => {
        try {
            const response = await fetch("https://rendersgr1server-production.up.railway.app/enrollment/all",
                {
                    method: "GET",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`https://rendersgr1server-production.up.railway.app/enrollment/search?${params}`,
                {
                    method: "GET",
                    headers: { "Content-Type": "application/json" },
                    credentials: "include"
